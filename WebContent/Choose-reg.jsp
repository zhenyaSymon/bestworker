...
<div id="Choosereg" class="container">
<p id ="Ras">Register as :</p>
<div id="Rcontent">
		<div id="onecolumn">
			<div class="Rmenu1">
					<div id = "align"><a href="worker-reg.jsp" >Worker</a></div>
		...
		<div id="Rsidebar">
		<div class="Rmenu2">
					<div id="align"><a href="agent-reg.jsp" >Agent</a></div>
